...
class Inmueble
{
     ...
     * Add category
     *
     * @param \InmuebleBundle\Entity\Category $category
     * @return Inmueble
     */
    public function addCategory(\InmuebleBundle\Entity\Category $category)
    {
     ...
     * @param \InmuebleBundle\Entity\Category $category
     */
    public function removeCategory(\InmuebleBundle\Entity\Category $category)
    {
